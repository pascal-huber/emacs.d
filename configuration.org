...
[[https://github.com/syl20bnr/spacemacs/tree/master/layers/%2Blang/haskell][how spacemacs does it]]
...
[[https://github.com/haskell/haskell-mode][Haskell-Mode]] is an Emacs mode for editing, debugging and developing Haskell
programs. [[http://haskell.github.io/haskell-mode/][Home page]].

The most important keybindings start with =C-c
C-....=, use =which-key= for an overview.

#+BEGIN_SRC emacs-lisp
(ph/install-package 'haskell-mode)
#+END_SRC
...
(add-hook 'haskell-mode-hook
          (lambda () (run-hooks 'prelude-haskell-mode-hook)))
#+END_SRC
...
Auto-completion without =stack= (I think I'll use =stack=)

#+BEGIN_SRC emacs-lisp
;; (ph/install-package 'company-ghc)
;; (add-to-list 'company-backends 'company-ghc)
;; (custom-set-variables '(company-ghc-show-info t))
#+END_SRC

Auto-completion with =stack=

#+BEGIN_SRC emacs-lisp
(ph/install-package 'intero)
(add-to-list 'company-backends 'intero-repl-mode)
#+END_SRC
