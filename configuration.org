...
Only use the =powerline-active1= and =powerline-active2= faces.

#+BEGIN_SRC emacs-lisp
(defun ph/spaceline-face-func (face active)
  (pcase (cons face active)
    ...
    ('(line  . t)   'powerline-active1)
    ('(line  . nil) 'powerline-inactive1)
    ('(highlight . t)   (funcall spaceline-highlight-face-func))
    ('(highlight . nil) (funcall spaceline-highlight-face-func))))

(setq spaceline-face-func 'ph/spaceline-face-func)
#+END_SRC
