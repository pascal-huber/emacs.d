...
# TODO: check if security measures are needed for melpa (package-check-signature?)
...
[[https://github.com/bbatsov/prelude/issues/1225][See this issue]].

# TODO: investigate gnutls package installation issue
