...
[[https://github.com/jgm/pandoc][Pandoc]] [[https://github.com/jgm/pandoc ][http://githubbadges.com/star.svg?user=sirpscl&repo=emacs.d&style=flat]] is
a swiss-army knife for converting documents.
...
=M-x ph/save-buffer= checks if the current buffer's file is writable. If not, try
saving it as root.
