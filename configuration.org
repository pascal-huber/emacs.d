...
To prevent UID errors with mbsync
...
(setq mu4e-contexts
      `(,(make-mu4e-context
          ...
          :vars '((user-full-name                . "Pascal Huber" )
                  ...
                  (mu4e-get-mail-command         . "mbsync {private,quickshift,eth}")
        ...
        ,(make-mu4e-context
          ...
          :vars '((user-full-name                . "Pascal Huber" )
                  ...
                  (mu4e-get-mail-command         . "mbsync {private,quickshift,eth}")
                  (mu4e-drafts-folder            . "/quickshift/Drafts")
                  (mu4e-sent-folder              . "/quickshift/Sent")
                  (mu4e-trash-folder             . "/quickshift/Trash")
                  (mu4e-maildir-shortcuts
                   .( ("/quickshift/Inbox"       . ?i)
                      ("/quickshift/Sent"        . ?s)
                      ("/quickshift/spambucket"  . ?x)
                      ("/quickshift/keep"        . ?k)
                      ("/quickshift/tempKeep"    . ?t)
                      ("/quickshift/Trash"       . ?b)))
                  (mu4e-sent-messages-behavior   . sent)
                  (smtpmail-stream-type          . starttls)
        ...
        ,(make-mu4e-context
          ...
          :vars '((user-full-name                . "Pascal Huber" )
                  ...
                  (mu4e-sent-folder              . "/eth/Sent Items")
